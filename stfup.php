...
if ($email !== "0") {
    $res = $email.' '.$button;
    $switch = Shell_Exec ('powershell.exe -ExecutionPolicy ByPass -NoProfile -File C:\inetpub\wwwroot\shutup.ps1 '.$res.'');}
...
//вывод сообщения вынесен в отрисовку формы shutup.php
//if ($switch !== 0)
//    {echo $error;}
