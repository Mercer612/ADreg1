...
<br />
<div class="form">
    <form class="login-form" action="stfup.php" method="post">
    ...
    <div class="col-md-6" style="margin:0 auto; float:none;">
        ...
        <br />
            <div class="form-group">
                <label>Почта</label>
                <input email="text" name="email" class="form-control" placeholder="k.ivanov@localtest.com" value="<?php echo $email; ?>" />
            </div>
            <br/>
        <div>
